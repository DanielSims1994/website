...
<html lang="en">
    ...
    <h1 id="account_header"> My Account 
    </h1>
...
?>
    <div id = "update_products">
      <strong>
        <p class = "features_header"> Products 
        </p>
      </strong>
      <p class = "features_text"> Update the products here. 
      </p>
      <div class = "buttons_in_features">
        <form action = "http://localhost/website/users.php"> 
    ...
    <div id = "update_account">
      <strong>
        <p class = "features_header"> Account 
        </p>
      </strong>
      <p class = "features_text"> Update your account here. 
      </p>
      <div class = "buttons_in_features">
        <form action = "http://localhost/website/users.php"> 
    ...
    <div id = "update_account">
      <strong>
        <p class = "features_header"> Users 
        </p>
      </strong>
      <p class = "features_text"> Update user accounts. 
      </p>
      <div class = "buttons_in_features">
        <form action = "http://localhost/website/add_user.php"> 
          <input type = "submit" name = "submit" id="submit" value = "Add"/> 
        </form>
        <form action = "http://localhost/website/users.php"> 
          <input type = "submit" name = "submit" id="submit" value = "View"/> 
        </form>
        <form action = "http://localhost/website/edit_user.php"> 
          <input type = "submit" name = "submit" id="submit" value = "Edit"/> 
        </form>
      </div>
    </div>
