    ...
    <div class="sign_up_and_in_container">
      <form action="sign_up.php" method="post">
        <Fieldset class = "field_wrapper">
          <h1 id="account_header"> Sign up 
          </h1>
          <p> First name 
          </p>
          <input type="text" name = "firstname" id="firstname" placeholder = "Firstname" value="<?php echo $_POST['firstname']; ?>"/> 
          <br/> 
          <p> Surname 
          </p>
          <input type="text" name = "surname" id="surname" placeholder = "Surname" value="<?php echo $_POST['surname']; ?>"/> 
          <br />
          <p> Age (between 12 and 130) 
          </p>
          <input type="text" name = "age" id="age" placeholder = "Age" value="<?php echo $_POST['age']; ?>"/> 
          <br />
          <p> Email address 
          </p>
          <input type="text" name = "email" id="email" placeholder = "Email address" value="<?php echo $_POST['email']; ?>"/>  
          <br />
          <p> Password (at least 8 characters) 
          </p>
