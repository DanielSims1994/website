...
?>
      <tr>
        ...
        <td>
          <input type="text" name="surname" value="<?php echo $results['surname']?>">
        </td>
        <td>
          <input type="text" name="email" value="<?php echo $results['email']?>">
        </td>
        <td>
          <input type="text" name="age" value="<?php echo $results['age']?>">
        </td>
        <td>
          <select>
            <option name = "administrator" value="Administrator" 
